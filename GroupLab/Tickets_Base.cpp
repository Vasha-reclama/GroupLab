...
void Ticket::createDatabase(const char* filename) {
    ofstream file(filename, ios::out | ios::binary);
}

void Ticket::readDatabase(const char* filename) {
...
void Ticket::addTicket(const char* filename, const Ticket& newTicket) {
...
void Ticket::deleteTicket(const char* filename, int ticketNumberToDelete) {
...
void Ticket::editTicket(const char* filename, int ticketNumberToEdit, const Ticket& updatedTicket) {
    ifstream inFile(filename, ios::in | ios::binary);
    if (!inFile) {
        cout << "Error opening file for reading." << endl;
        return;
